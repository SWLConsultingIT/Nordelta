...
El sistema visual vive en `informe_estilo.py`, compartido con el resumen.
"""
import pathlib
import subprocess
import sys
...
from informe_estilo import CSS, documento, hacer_captura, hoja  # noqa: E402
...
SALIDA_HTML.write_text(
    documento(
        ...
        PAGINAS,
        pie="Nordelta · Arquitectura de producto · septiembre 2026",
    )
)
